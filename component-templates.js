...
<section id="login-section" class="full-screen-section">
    <div class="login-container">
        ...
        `,
        'manager-dashboard': `
<section id="manager-dashboard" class="dashboard-section hidden full-screen-section">
    <div class="dashboard-container">
        ...
        `,
        'cashier-dashboard': `
<section id="cashier-dashboard" class="dashboard-section hidden full-screen-section">
    <div class="dashboard-container">
        <aside class="sidebar">
            <div class="sidebar-logo">
                <img src="images/jowens.png" alt="Jowen's Kitchen & Cafe Logo">
